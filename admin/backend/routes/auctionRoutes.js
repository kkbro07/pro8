// admin/backend/routes/auctionRoutes.js
...
router.post('/bid', async (req, res) => {
  try {
    const { auctionRoundId, bidAmount, userId } = req.body;
    ...
    auctionRound.highestBidder = userId;
    auctionRound.bids.push({ userId, bidAmount });
